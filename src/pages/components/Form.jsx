    ...
    return(
        <form class="space-y-8">
                ...
                <div class="px-4 mx-auto max-w-screen-md text-center">
                    <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none">Enviar mensagem</button>
                </div>
            </form>
    )
}