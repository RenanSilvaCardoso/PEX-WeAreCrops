...
function About() {
    ...
    return (
        <div class="w-full space-y-4 overflow-hidden">
            <h1 id='title' class="font-bold text-3xl opacity-0 text-center mt-2 duration-1000 md:text-4xl">Sobre o Crops</h1>
            <div id='history' class="w-full flex flex-col justify-center items-center duration-1000 opacity-0 delay-200">
                <div class="w-full flex justify-center items-center gap-1">
                    <h2 class="font-bold text-2xl md:text-3xl">História do Crops</h2>
                    <img src={historySvg} alt="caneta" class="size-7 md:size-9 animate-oscilation z-0" />
                </div>
                <div class="w-[90%] md:w-[70%] text-pretty py-2">
            ...
            <div id='mission' class="w-full flex flex-col justify-center items-center delay-500 duration-1000 opacity-0">
                <div class="w-full flex justify-center items-center gap-1">
                    <h2 class="font-bold text-2xl md:text-3xl">Missão  do Crops</h2>
                    <img src={missionSvg} alt="caneta" class="size-7 md:size-9 animate-oscilation" />
                </div>
                <div class="w-[90%] md:w-[70%] text-pretty py-2" >
                    <p class="indent-8 text-lg">
            ...
            <div id='vision' class="w-full flex flex-col justify-center items-center delay-700 duration-1000 opacity-0">
                <div class="w-full flex justify-center items-center gap-1">
                    <h2 class="font-bold text-2xl md:text-3xl">Visão  do Crops</h2>
                    <img src={visionSvg} alt="caneta" class="size-7 md:size-9 animate-oscilation" />
                </div>
                <div class="w-[90%] md:w-[70%] text-pretty py-2" >
                    <p class="indent-8 text-lg">
            ...
            <div id='values' class="w-full flex flex-col justify-center items-center delay-1000 duration-1000 opacity-0">
                <div class="w-full flex justify-center items-center gap-1">
                    <h2 class="font-bold text-2xl md:text-3xl">Valores  do Crops</h2>
                    <img src={valuesSvg} alt="caneta" class="size-7 md:size-9 animate-oscilation" />
                </div>
                <div class="w-[90%] md:w-[50%] text-pretty py-2 md:text-left" >
                    <ul>
                        <li class="text-lg"><span class="font-bold">Qualidade:</span> Utilizamos apenas ingredientes frescos e de origem conhecida, garantindo a excelência em cada prato servido.</li>
                        <li class="text-lg"><span class="font-bold">Autenticidade:</span> Cada receita é preparada do zero, respeitando o tempo e o processo de cada ingrediente.
                        </li>
                        <li class="text-lg"><span class="font-bold">Sustentabilidade:</span> Priorizamos práticas que respeitem o meio ambiente e os produtores locais.
                        </li>
                        <li class="text-lg"><span class="font-bold">Acolhimento:</span> Cada cliente é recebido com carinho e atenção, fazendo com que se sintam parte da nossa família.
                        </li>
                        <li class="text-lg"><span class="font-bold">Paixão pela Culinária:</span> Acreditamos no poder transformador da comida feita com amor e dedicação.
                        </li>
                    </ul>
                </div>
            </div>
